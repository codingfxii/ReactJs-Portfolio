      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7 text-sm text-center md:text-start">
            ...
            Technology Student,
             Digital Artist & Aspiring Front-End Developer.
          </p>
        </motion.div>
        ...
        >
          ...
          <AnchorLink
            className="rounded-r-sm bg-black text-white  "
            onClick={() => setSelectedPage("contact")}
            href="#contact"
          >
            <div className=" hover:bg-yellow  hover:text-white transition duration-500 w-full h-full flex items-center justify-center px-10 font-semibold">
              Let's talk.
            </div>
          </AnchorLink>
        </motion.div>
